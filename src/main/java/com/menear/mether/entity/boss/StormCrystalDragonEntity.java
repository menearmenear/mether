...
public class StormCrystalDragonEntity extends HostileEntity {

    private final ServerBossBar bossBar = new ServerBossBar(
        this.getDisplayName(), BossBar.Color.YELLOW, BossBar.Style.PROGRESS
    );

    public StormCrystalDragonEntity(EntityType<? extends StormCrystalDragonEntity> entityType, World world) {
    ...
    public static class TargetGoal extends ActiveTargetGoal<PlayerEntity> {
        public TargetGoal(StormCrystalDragonEntity mob, Class<PlayerEntity> targetClass, boolean checkVisibility) {
