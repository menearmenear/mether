...
public class FrostCrystalLeviathanEntity extends HostileEntity {

    private final ServerBossBar bossBar = new ServerBossBar(
        this.getDisplayName(), BossBar.Color.BLUE, BossBar.Style.PROGRESS
    );

    public FrostCrystalLeviathanEntity(EntityType<? extends FrostCrystalLeviathanEntity> entityType, World world) {
    ...
    public static class TargetGoal extends ActiveTargetGoal<PlayerEntity> {
        public TargetGoal(FrostCrystalLeviathanEntity mob, Class<PlayerEntity> targetClass, boolean checkVisibility) {
