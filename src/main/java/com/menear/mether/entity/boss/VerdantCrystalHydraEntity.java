...
public class VerdantCrystalHydraEntity extends HostileEntity {

    private final ServerBossBar bossBar = new ServerBossBar(
        this.getDisplayName(), BossBar.Color.GREEN, BossBar.Style.PROGRESS
    );

    public VerdantCrystalHydraEntity(EntityType<? extends VerdantCrystalHydraEntity> entityType, World world) {
    ...
    public static class TargetGoal extends ActiveTargetGoal<PlayerEntity> {
        public TargetGoal(VerdantCrystalHydraEntity mob, Class<PlayerEntity> targetClass, boolean checkVisibility) {
