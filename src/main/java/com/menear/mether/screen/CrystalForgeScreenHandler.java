...
public class CrystalForgeScreenHandler extends ScreenHandler {

    private final Inventory inventory;

    public CrystalForgeScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(9));
    }

    public CrystalForgeScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(MetherScreenHandlers.CRYSTAL_FORGE, syncId);
        checkSize(inventory, 9);
        this.inventory = inventory;

        // Crystal Forge inventory (3x3 grid)
